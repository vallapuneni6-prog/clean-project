...
function verifyAuthorization($requireAuth = true) {
     ...
     if (session_status() === PHP_SESSION_NONE) {
         ...
         $sessionPath = dirname(dirname(__DIR__)) . DIRECTORY_SEPARATOR . 'tmp' . DIRECTORY_SEPARATOR . 'sessions';
...
function setAuthHeaders() {
    // CORS headers - allow ansira.in domain
    $origin = $_SERVER['HTTP_ORIGIN'] ?? 'https://ansira.in';
    if (strpos($origin, 'ansira.in') !== false || $origin === 'https://ansira.in') {
        header('Access-Control-Allow-Origin: ' . $origin);
    } else {
        header('Access-Control-Allow-Origin: https://ansira.in');
    }
